...
<?php
		...
		{
  ?>
<form name="myForm" class="lead-form" onsubmit="return validate(this);" action="orderformmultiproducts.php" method="POST" enctype="multipart/form-data">
...
<h1 class="title-text">New Order Form for Multiple Products&ensp;&ensp;<a href="orderform.php?leadid=<?php echo $lead_id; ?>&custid=<?php echo $cust_id; ?>" style="font-size: 18px;font-weight: 500;text-decoration:  underline;">(Single Products Order Form)</a></h1>
<div class="cover">
...
<td>
<input type="text" value="" name="product_name2" class="required">
</td>
<td>
<input list="capacities" type="text" value="" name="product_capacity2" class="required">
</td>
<td>
<input type="text" value="" name="product_code2" >
</td>
<td>
<input type="text" value="" name="price2" class="required" id="price2" onkeyup="revertAmount(2)">
</td>
<td>
<input type="text" value="" name="quantity2" class="required" id="quantity2" onkeyup="revertAmount(2)">
</td>
<td>
...
<td>
<input type="text" value="" name="totalamount2" id="totalamount2" class="required" readonly>
</td>
</tr>
...
$results2 = $db->query("UPDATE `leads` SET `lead_status` = 'converted' WHERE `leads`.`lead_id` = '$lead_id'");
if($results2){
...
$to2 = $email1;
$subject2 = 'Your Order #'.$last_id.' is Confirmed';
